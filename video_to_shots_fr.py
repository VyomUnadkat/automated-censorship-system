...
if __name__ == '__main__':
    ...
    data_folder_path = os.path.join(current_dir_path, '/Users/vyomunadkat/Desktop/fv_new_final/fr/')
...
feat_filepath = os.path.join( 'start_fr.npy')

with open(feat_filepath, 'wb') as f:
    np.save(f, starting_ts)
    
feat_filepath = os.path.join( 'end_fr.npy')

with open(feat_filepath, 'wb') as f:
    np.save(f, ending_ts)

ss = np.load('start_fr.npy')
ee = np.load('end_fr.npy')
